...
export const routes: Routes = [
  ...
  { path: 'my-qr',    loadComponent: () => import('./components/member-qr/member-qr').then(m => m.MemberQr), canActivate: [authGuard] },
  { path: 'qr-scanner', loadComponent: () => import('./components/qr-scanner/qr-scanner').then(m => m.QrScanner), canActivate: [adminGuard] },
